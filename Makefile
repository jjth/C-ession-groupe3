...
Pair:		src/pair.c
	$(CC) -o build/pair/Pair lib/libini/ini.c src/modules/configparser.c src/modules/dataStructure.c src/modules/colors.c src/globals.c src/modules/server.c src/pair.c  $(CFLAGS)

Impair:		src/impair.c
	$(CC) -o build/impair/Impair lib/libini/ini.c src/modules/configparser.c src/modules/dataStructure.c src/modules/colors.c src/globals.c src/modules/server.c src/impair.c  $(CFLAGS)
