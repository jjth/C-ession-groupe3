...
Central:	src/central.c
	$(CC) -o build/Central lib/libini/ini.c src/modules/configparser.c src/modules/colors.c src/modules/readLines.c src/modules/rulesParser.c src/modules/readFile.c src/modules/scanf.c src/central.c $(CFLAGS)
